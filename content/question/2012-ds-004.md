...
![](/cc408/images/questions/exam/2012/2012_Q4_1.svg)对于高度为 N、左右子树的高度分别为 N-1 和 N-2、所有非叶结点的平衡因子均为 1 的平衡二叉树，总结点数的公式为：CN=CN−1+CN−2+1,C1=1,C2=2,C3=2+1+1=4，可推出C6=20。
