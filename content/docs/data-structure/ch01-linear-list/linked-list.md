...
由于数组在内存中的存储是 **连续** 的，这有利于程序的 [**空间局部性**](/docs/computer-org/ch02-memory/cache/#%e7%a9%ba%e9%97%b4%e5%b1%80%e9%83%a8%e6%80%a7)，当访问一个元素时，相邻的元素也会被加载到 **CPU 缓存** 中，这提高了访问速度。  
