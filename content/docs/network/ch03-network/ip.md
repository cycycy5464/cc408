...
当 IP 分组经过 **路由器** 时，路由器会自动 IP 分组中的 **TTL 值减 1** ，路由器 发现其 **TTL = 0** ，则路由器会 **丢弃** 该 IP 分组，并且返回一个 [ICMP](/docs/network/ch03-network/icmp/) “Time Exceed” 消息。
...
**VLSM** 实质上是一种 [前缀编码](/docs/data-structure/ch04-tree/tree/#%e5%89%8d%e7%bc%80%e7%bc%96%e7%a0%81) 方式，要求各子网的前缀互不包含，以确保地址空间的唯一划分。

这里采用二叉树进行子网划分的思想和 [操作码扩展编码](/docs/computer-org/ch03-instruction/format-addressing/#%e6%93%8d%e4%bd%9c%e7%a0%81%e6%89%a9%e5%b1%95%e7%bc%96%e7%a0%81) 类似，可以思考其相似性。
