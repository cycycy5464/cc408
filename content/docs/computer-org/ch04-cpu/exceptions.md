...
本节也基本是选择题必考，要掌握 **异常和中断的区别** ，就是概念上要区分开，不知道为啥，老头们很喜欢考这个。关于中断的具体介绍参考 [组成原理相关章节](/docs/computer-org/ch05-bus/bus/#%e7%a8%8b%e5%ba%8f%e4%b8%ad%e6%96%ad%e6%96%b9%e5%bc%8f) 的内容。
...
[**陷阱指令**](/docs/computer-org/ch03-instruction/instruction-index/#%e9%99%b7%e9%98%b1%e6%8c%87%e4%bb%a4) 是显式由程序发起的指令，用于触发自陷事件。它常用于系统调用、调试等场景，是用户程序与操作系统交互的重要机制。
...
中断处理流程参考组成原理中的 [该节](/docs/computer-org/ch05-bus/bus/#%e7%a8%8b%e5%ba%8f%e4%b8%ad%e6%96%ad%e6%96%b9%e5%bc%8f)。
