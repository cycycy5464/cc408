...
![](/cc408/images/docs/computer-org/58d09d232f.svg)
...
![](/cc408/images/docs/computer-org/f9ac9a53aa.svg)
...
![](/cc408/images/docs/computer-org/f3b88df4bd.svg)
...
![](/cc408/images/docs/computer-org/7b1f088355.svg)

**控制信号发生器** 负责接收 **指令译码器** 的结果，并且在每个 **时钟周期** 内产生 [控制信号](/docs/computer-org/ch04-cpu/controller/#%e6%8e%a7%e5%88%b6%e4%bf%a1%e5%8f%b7)。
...
![](/cc408/images/docs/computer-org/image-20260612231905011.png)
...
![](/cc408/images/docs/computer-org/image-20260612231919337.png)
...
![](/cc408/images/docs/computer-org/8b3a958593.svg)


![](/cc408/images/docs/computer-org/c06407994a.svg)
...
[指令的执行阶段](/docs/computer-org/ch04-cpu/pipeline/#%e6%8c%87%e4%bb%a4%e6%89%a7%e8%a1%8c%e9%98%b6%e6%ae%b5) 包含取指、译码、执行、访内和写回阶段，在这五个阶段中 **控制单元** 会发出不同的 **控制信号** ，以实现指令的执行。

以指令 `ADD R0, (R1)` 为例，说明一下指令执行阶段四个阶段的 **控制信号** 以及相应的功能，功能用寄存器传送语言给出描述。

#### 取指和译码阶段

![](/cc408/images/docs/computer-org/069589e8ef.svg)
...
![](/cc408/images/docs/computer-org/90955c1df9.svg)
...
![](/cc408/images/docs/computer-org/22ab2f56d5.svg)
...
![](/cc408/images/docs/computer-org/image-20260612232731403.png)
...
![](/cc408/images/docs/computer-org/image-20260612232753280.png)
...
![](/cc408/images/docs/computer-org/image-20260612232812017.png)
...
![](/cc408/images/docs/computer-org/image-20260612232823435.png)
...
![](/cc408/images/docs/computer-org/image-20260612232838380.png)
...
回顾一下微程序控制器的 [结构](/docs/computer-org/ch04-cpu/controller/#%e7%bb%93%e6%9e%84)，对于控制器来说：输入是机器指令，输出是每个时钟周期不同的微命令。这种控制的实现机制是基于控制存储器（Control Memory, CM）。控制存储器内部存储着预先定义好的微指令序列。

所以一个指令对应一个微程序，一个微程序中包含多个微指令，每个微指令对应一系列微命令。下图展现了三者的层次关系：

![](/cc408/images/docs/computer-org/9b05f97b63.svg)

在上文的 [指令的控制信号](/docs/computer-org/ch04-cpu/controller/#%e6%8c%87%e4%bb%a4%e7%9a%84%e6%8e%a7%e5%88%b6%e4%bf%a1%e5%8f%b7) 部分，我们详细阐述了指令 **ADD R0, \(R1\)** 所对应的微操作序列。为了进一步帮助各位读者理解 **指令** 、**微指令** 、**微命令** 三者之间的区别与联系，本节将通过以下表格，具体说明该指令（相当于一个微程序）各阶段的微指令和微命令：
