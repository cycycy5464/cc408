...
在 低位交叉编址 中，**相邻地址的数据分布在不同的存储体中** ，多个存储体可以 **并行处理请求** ，这种并行方式类似于 [指令流水线](/docs/computer-org/ch04-cpu/pipeline/)，极大提升了主存的访问带宽。
...
![storage chip](/cc408/images/docs/computer-org/fa8d49168c.png)
