...
![](/cc408/images/docs/computer-org/image-20260612221357978.png)
...
在实际的计算机中，没有采用 [原码](/docs/computer-org/ch01-data-representation/integers/#%e5%8e%9f%e7%a0%81) 存储数据的，具体原因后面会谈到到。对于计算机中存储的数字来说，它的二进制只可能是 **有符号数** （signed） 或者 **无符号数** （unsigned） 这两种情况。
...
需要注意的是，**无符号数** 就是没有符号的二进制表示，它不像 **有符号数** 的表示，有一个 [补码](/docs/computer-org/ch01-data-representation/integers/#%e8%a1%a5%e7%a0%81%e8%a1%a8%e7%a4%ba) 这个专有名词。但是我们一般可以叫它 **纯二进制** 或 **无符号数二进制表示** 。
...
![](/cc408/images/docs/computer-org/cf4cec8aa2.svg)
...
![](/cc408/images/docs/computer-org/a20b498948.svg)
...
对于表示范围内的正数，**补码** 和 [纯二进制表示](/docs/computer-org/ch01-data-representation/integers/#%e7%ba%af%e4%ba%8c%e8%bf%9b%e5%88%b6%e8%a1%a8%e7%a4%ba) 的二进制表示是相同的；但是对于负数，两者的二进制表示不同，这也是它名称的来源。
...
比如假设给定一个十进制 D ，首先我们可以通过 [除 2 取余法](/docs/computer-org/ch01-data-representation/integers/#%e9%99%a42%e5%8f%96%e4%bd%99%e6%b3%95) 计算其 **纯二进制表示** Ubinary​=un−1​⋯u1​u0​ ，然后再用 2n 减去这个数：

![](/cc408/images/docs/computer-org/1cd47f4625.svg)
...
![](/cc408/images/docs/computer-org/432b89c9c3.svg)
...
比如通过第二种方式将 -73 转为 **补码** ：
  ...
  1. -73 是负数，其绝对值为 73。
  2. 通过 [除 2 取余法](/docs/computer-org/ch01-data-representation/integers/#%e9%99%a42%e5%8f%96%e4%bd%99%e6%b3%95) 得到其 **无符号表示** 为 0100 1001。
  3. 取反：1011 0110。
  4. 加一：1011 0111。

结果为 **1011 0111** 。

![](/cc408/images/docs/computer-org/86175661a7.svg)
...
![](/cc408/images/docs/computer-org/3071199e4e.svg)
