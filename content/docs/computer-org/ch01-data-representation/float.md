...
实数在计算机中的存储遵循 [IEEE 浮点数标准](</constitution_principle/representation/floats/#ieee-floating-point>)，但在这里为了方便理解 IEEE 标准，这里首先阐明一般 **实数** 在计算机中是如何存储的。
...
* 对于 **双精度** 浮点数
  ...
  * n 位的 frac=0⋅fn−1​⋯f1​f0​ 用于计算 **因子** M ，其中 M=1+frac ， frac 表示的小数计算方式见 [实数的二进制表示](</constitution_principle/representation/floats/#%e5%ad%97%e9%9d%a2%e5%80%bc%e8%bd%ac%e4%ba%8c%e8%bf%9b%e5%88%b6>)
...
一般而言，试题只会考察这种没有精度损失的 **浮点数二进制转换** ，对于有精度损失的情况，由于比较繁琐，基本不会考察，其 **尾数** 部分的计算与 [一般实数字面值转二进制](</constitution_principle/representation/floats/#%e5%ad%97%e9%9d%a2%e5%80%bc%e8%bd%ac%e4%ba%8c%e8%bf%9b%e5%88%b6>) 相同。
