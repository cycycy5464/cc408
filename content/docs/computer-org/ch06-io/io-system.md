...
上文提到的是 I/O 系统的 **硬件层次** ，除了硬件部分，I/O 系统还包括一系列的 **软件组件** ，用以管理和调度外设资源、提供抽象接口、增强设备的可用性和通用性。主要的 [软件层次](/docs/os/ch04-io/devices/#io-%e8%bd%af%e4%bb%b6%e5%b1%82%e6%ac%a1) 如下：
