...
页式虚拟存储的细节都在 [组成原理章节](/docs/os/ch02-memory/virtual/)，对于本节，重点掌握 **页框分配的几个概念** 以及几种 **页面置换算法** 的细节。
...
![](/cc408/images/docs/os/d199190ebc.svg)
...
![](/cc408/images/docs/os/58b34dc89a.svg)
...
![](/cc408/images/docs/os/2311317e7c.svg)

**固定分配** 中可以分为两种方式，一种是将内存分为若干大小相同的分区，另一种是将内存分为大小不同的分区。

![](/cc408/images/docs/os/image-20260611222826217.png)

**可变分配** 也包含两种分配方式，一种就是将 [内存分为若干页面](/docs/os/ch02-memory/virtual/#%e8%af%b7%e6%b1%82%e9%a1%b5%e5%bc%8f%e7%ae%a1%e7%90%86)，然后根据进程的需求为其动态地分配内存页面。另一种思路与 [动态分区分配](/docs/os/ch02-memory/concepts/#%e5%8a%a8%e6%80%81%e5%88%86%e5%8c%ba%e5%88%86%e9%85%8d) 一致，在一块连续的内存上动态地申请连续的某个长度的存储空间。


![](/cc408/images/docs/os/b997241c78.svg)
...
![](/cc408/images/docs/os/0f05ae61df.svg)
...
![](/cc408/images/docs/os/dc259d9ac9.svg)
...
![](/cc408/images/docs/os/20f9199ce8.svg)

举个 **实际例子** 来说明一下 OPT 页面置换算法的运行过程：

加入内存系统中有 3 个页框，页面引用序列为`7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 2`，则置换页面如下：

![](/cc408/images/docs/os/image-20260611222902162.png)
...
![](/cc408/images/docs/os/fc90a07988.svg)
...
![](/cc408/images/docs/os/image-20260611222938889.png)

LRU 的 **执行流程** 可以通过以下流程图理解：


![](/cc408/images/docs/os/a52d251e2e.svg)

加入内存系统中有 3 个页框，页面引用序列为`7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 2`，则置换页面如下：

![](/cc408/images/docs/os/image-20260611222955673.png)

内存置换次数为 6，缺页率为 **_6/12 = 1/2_**

#### Clock

根据 [LRU 代码实现](/docs/computer-org/ch03-instruction/opcode/) 可知，用代码实现一个高效的 **LRU** 算法需要用到一个散列表和一个基于链表的队列，这从软件层面实现不算特别复杂，但若是要用硬件实现相应的逻辑则不大容易。
...
![](/cc408/images/docs/os/9e990ddc27.svg)
...
![](/cc408/images/docs/os/a2fc7ddeb7.svg)
...
![](/cc408/images/docs/os/e0411c4cd2.svg)
...
![](/cc408/images/docs/os/b87550eab7.svg)
...
![](/cc408/images/docs/os/image-20260611223118638.png)
...
![](/cc408/images/docs/os/image-20260611223126794.png)
...
![](/cc408/images/docs/os/56b6b3e85b.svg)
