...
因此，[启动流程](/docs/os/ch02-memory/concepts/#%e5%bc%95%e5%af%bc%e6%b5%81%e7%a8%8b) 可以概括为：**ROM** 中的固件 → MBR 中的 **Bootloader** → 分区启动扇区中的 **引导程序** → 操作系统的 **初始化程序** ，每一阶段都将控制权传递给下一阶段，直至操作系统完全运行。
